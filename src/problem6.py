...
def run_test_problem6():
    ...
    actual = problem6(sequence)  # Run the code to test
...
def problem6(seq_of_seq):
    ...
    Examples:
      ...
      problem6( [[10, 12], (23, 1)]  ) returns [12, 23]
      problem6( ([1], [], [2, 5] )   ) returns [1, 2]
      problem6( [[], [], [] )          returns []
      problem6( [1,3,2], [10, 5], []]) returns [3,10]
